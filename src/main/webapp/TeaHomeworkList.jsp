...
<div class="main-body">
    ...
    <div class="main-content">
        ...
        <div class="content row">
            ...
            <h5><span><s:property value="cname"/></span>/学生作业列表</h5>
            <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp small-12">
                ...
                <s:iterator value="stuHomeworks">
                    <tr>
                        ...
                        <td data-colomn="助教评分"><s:property value="score"/></td>
                        <td data-colomn="操作"><a href="teacher_acceptHomework?shid=<s:property value="shid"/>&csid=<s:property value="csid"/>&hid=<s:property value="hid"/>" style="margin-right: 2rem;">同意</a><a href="teacher_rejectHomework?shid=<s:property value="shid"/>&csid=<s:property value="csid"/>&hid=<s:property value="hid"/>" style="color: deeppink">拒绝</a></td>
                    </tr>
                </s:iterator>
                </tbody>
            </table>
