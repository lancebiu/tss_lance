...
<div class="main-body">
    ...
    <div class="main-content">
        ...
        <div class="content row">
            ...
            <s:iterator value="homeworkEntities">
                <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp small-12">
                    ...
                    <tr>
                        <td>作业样例</td>
                        <td style="text-align: left"><a href="#" class="fa fa-file-pdf-o" style="color: black;">样例</a></td>
                    </tr>
                    <tr>
                        <td>学生作业</td>
                        <td style="text-align: left"><a href="assist_findMyStuHomework?csid=<s:property value="csid"/>&hid=<s:property value="hid"/>">前往查看</a></td>
                    </tr>
                    </tbody>
                </table>
            </s:iterator>
